...
* Set up my developer environment and VS Code, practised Git basics such as `git config`, cloning, committing, pulling and pushing changes, and started running the repository commands from the documentation, including the initial setup steps and data preparation sections.
* Started reading papers on ocular datasets, federated learning for diagnosing AMD and segmentation, while also getting more familiar with the repository structure and working through some early setup errors.
